						<?php
//
// File generated by ... on the 2019-04-10T12:21:12+0200
// Please do not edit manually
//

/**
 * Classes and menus for itop-request-mgmt (version 2.6.0)
 *
...
define('PORTAL_USERREQUEST_TYPE', 'request_type');
...
class UserRequest extends Ticket
{
	public static function Init()
	{
		$aParams = array(			'category' => 'bizmodel,searchable,requestmgmt',
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'itop-request-mgmt/images/user-request.png',
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey("servicesubcategory_id", array("targetclass"=>'ServiceSubcategory', "allowed_values"=>new ValueSetObjects("SELECT ServiceSubcategory WHERE service_id = :this->service_id AND (ISNULL(:this->request_type) OR request_type = :this->request_type) AND status != 'obsolete'"), "sql"=>'servicesubcategory_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "depends_on"=>array('service_id', 'request_type'), "allow_target_creation"=>false, "display_style"=>'select', "always_load_in_tables"=>false)));
		...
		MetaModel::Init_DefineState(
			...
			array(
				"attribute_inherit" => 'new',
				"attribute_list" => array(
					'request_type' => OPT_ATT_MANDATORY,
		...
		MetaModel::Init_DefineHighlightScale( array(
		    'warning' => array('rank' => 1, 'color' => HILIGHT_CLASS_WARNING, 'icon' => utils::GetAbsoluteUrlModulesRoot().'itop-request-mgmt/images/user-request-deadline.png'),
		    'critical' => array('rank' => 2, 'color' => HILIGHT_CLASS_CRITICAL, 'icon' => utils::GetAbsoluteUrlModulesRoot().'itop-request-mgmt/images/user-request-escalated.png'),
		    'closed' => array('rank' => 3, 'color' => HILIGHT_CLASS_NONE, 'icon' => utils::GetAbsoluteUrlModulesRoot().'itop-request-mgmt/images/user-request-closed.png'),
		));
...
// Menus
//
class MenuCreation_itop_request_mgmt extends ModuleHandlerAPI
{
...
} // class MenuCreation_itop_request_mgmt
